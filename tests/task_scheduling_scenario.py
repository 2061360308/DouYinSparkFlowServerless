...
def check_scheduling(client, csrf):
    ...
    body = dict(account_id=account_id, target_name='friend', send_time='12:00', message_template='hello')
    ...
    service_headers = {'X-Service-Token': os.environ['SPARK_SERVICE_TOKEN']}
