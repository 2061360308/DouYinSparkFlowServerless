...
此模块只包含配置常量，不定义模型，避免与 ``core.db.models`` 包产生导入循环。
"""
    ...
    "apps": {
        "models": {
            "models": [
                ...
                "core.db.models.execution",
                "core.db.models.browser",
                "core.db.models.user",
                "core.db.models.account",
                "core.db.models.login",
                "core.db.models.quota",
                "core.db.models.invite",
                "core.db.models.task",
                "core.db.models.audit",
                "core.db.models.scheduled",
            ],
